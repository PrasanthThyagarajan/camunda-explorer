/**
 * Camunda Dashboard — Express server bootstrap.
 *
 * This file is now a thin composition root:
 *   - Instantiates dependencies (repository, services)
 *   - Mounts route modules
 *   - Starts the server
 *
 * SRP: Sole responsibility is application wiring and startup.
 * DIP: All dependencies are injected into route factories.
 */
...
// ── Instantiate dependencies (Composition Root) ─────────────────────
...
app.listen(PORT, () => {
  console.log("");
  console.log("╔══════════════════════════════════════════════════════════╗");
  console.log("║         Camunda Dashboard  v1.0.0                       ║");
  console.log("╠══════════════════════════════════════════════════════════╣");
